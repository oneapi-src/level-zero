...
zelTracerInitDriversRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerInitDriversRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnInitDriversCb);
...
zelTracerDriverGetDefaultContextRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDriverGetDefaultContextRegisterCallback") );
...
zelTracerDeviceSynchronizeRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceSynchronizeRegisterCallback") );
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerDeviceGetCounterBasedEventMaxValueRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceGetCounterBasedEventMaxValueRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetCounterBasedEventMaxValueCb);
...
zelTracerDeviceGetRuntimeRequirementsRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceGetRuntimeRequirementsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetRuntimeRequirementsCb);
...
zelTracerDeviceGetRuntimeRequirementsKeyRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceGetRuntimeRequirementsKeyRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetRuntimeRequirementsKeyCb);
...
zelTracerDeviceValidateRuntimeRequirementsRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceValidateRuntimeRequirementsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnValidateRuntimeRequirementsCb);
...
zelTracerCommandQueueGetOrdinalRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueGetOrdinalRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetOrdinalCb);
...
zelTracerCommandQueueGetIndexRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueGetIndexRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetIndexCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandQueueGetFlagsRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueGetFlagsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetFlagsCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandQueueGetModeRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueGetModeRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetModeCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandQueueGetPriorityRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueGetPriorityRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetPriorityCb);
...
zelTracerCommandListGetDeviceHandleRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetDeviceHandleRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetDeviceHandleCb);
...
zelTracerCommandListGetContextHandleRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetContextHandleRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetContextHandleCb);
...
zelTracerCommandListGetOrdinalRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetOrdinalRegisterCallback") );
...
zelTracerCommandListImmediateGetIndexRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateGetIndexRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateGetIndexCb);
...
zelTracerCommandListIsImmediateRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListIsImmediateRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnIsImmediateCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandListGetFlagsRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetFlagsRegisterCallback") );
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandListImmediateGetFlagsRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateGetFlagsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateGetFlagsCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandListImmediateGetModeRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateGetModeRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateGetModeCb);
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerCommandListImmediateGetPriorityRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateGetPriorityRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateGetPriorityCb);
...
zelTracerCommandListAppendMemoryCopyWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendMemoryCopyWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendMemoryCopyWithParametersCb);
...
zelTracerCommandListAppendMemoryFillWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendMemoryFillWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendMemoryFillWithParametersCb);
...
zelTracerCommandListAppendSignalEventWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendSignalEventWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendSignalEventWithParametersCb);
...
zelTracerCommandListAppendWaitOnEventsWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendWaitOnEventsWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendWaitOnEventsWithParametersCb);
...
zelTracerEventGetEventPoolRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventGetEventPoolRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetEventPoolCb);
...
zelTracerEventGetSignalScopeRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventGetSignalScopeRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetSignalScopeCb);
...
zelTracerEventGetWaitScopeRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventGetWaitScopeRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetWaitScopeCb);
...
zelTracerEventPoolGetContextHandleRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventPoolGetContextHandleRegisterCallback") );
...
zelTracerEventPoolGetFlagsRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventPoolGetFlagsRegisterCallback") );
...
ZE_APIEXPORT ze_result_t ZE_APICALL
zelTracerEventGetCounterBasedFlagsRegisterCallback(
    zel_tracer_handle_t hTracer,
    zel_tracer_reg_t callback_type,
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerEventGetCounterBasedFlagsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetCounterBasedFlagsCb);
...
zelTracerModuleGetDeviceHandleRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerModuleGetDeviceHandleRegisterCallback") );
...
zelTracerKernelGetModuleHandleRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerKernelGetModuleHandleRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetModuleHandleCb);
...
zelTracerCommandListAppendLaunchKernelWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendLaunchKernelWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendLaunchKernelWithParametersCb);
...
zelTracerCommandListAppendLaunchKernelWithArgumentsRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendLaunchKernelWithArgumentsRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendLaunchKernelWithArgumentsCb);
...
zelTracerMemGetPitchFor2dImageRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnGetPitchFor2dImageCb);
...
zelTracerImageGetDeviceOffsetExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerImageGetDeviceOffsetExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetDeviceOffsetExpCb);
...
zelTracerCommandListCreateCloneExpRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnCreateCloneExpCb);
...
zelTracerCommandListImmediateAppendCommandListsExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateAppendCommandListsExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateAppendCommandListsExpCb);
...
zelTracerCommandListImmediateAppendCommandListsWithParametersRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListImmediateAppendCommandListsWithParametersRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImmediateAppendCommandListsWithParametersCb);
...
zelTracerCommandListGetNextCommandIdExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetNextCommandIdExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetNextCommandIdExpCb);
...
zelTracerCommandListGetNextCommandIdWithKernelsExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListGetNextCommandIdWithKernelsExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetNextCommandIdWithKernelsExpCb);
...
zelTracerCommandListUpdateMutableCommandsExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListUpdateMutableCommandsExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnUpdateMutableCommandsExpCb);
...
zelTracerCommandListIsMutableExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListIsMutableExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnIsMutableExpCb);
...
zelTracerCommandListUpdateMutableCommandSignalEventExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListUpdateMutableCommandSignalEventExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnUpdateMutableCommandSignalEventExpCb);
...
zelTracerCommandListUpdateMutableCommandKernelsExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListUpdateMutableCommandKernelsExpRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnUpdateMutableCommandKernelsExpCb);
...
zelTracerDeviceImportExternalSemaphoreExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceImportExternalSemaphoreExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnImportExternalSemaphoreExtCb);
...
zelTracerDeviceReleaseExternalSemaphoreExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceReleaseExternalSemaphoreExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnReleaseExternalSemaphoreExtCb);
...
zelTracerCommandListAppendSignalExternalSemaphoreExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendSignalExternalSemaphoreExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendSignalExternalSemaphoreExtCb);
...
zelTracerCommandListAppendWaitExternalSemaphoreExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendWaitExternalSemaphoreExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendWaitExternalSemaphoreExtCb);
...
zelTracerRTASBuilderCreateExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASBuilderCreateExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnCreateExtCb);
...
zelTracerRTASBuilderGetBuildPropertiesExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASBuilderGetBuildPropertiesExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetBuildPropertiesExtCb);
...
zelTracerDriverRTASFormatCompatibilityCheckExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDriverRTASFormatCompatibilityCheckExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnRTASFormatCompatibilityCheckExtCb);
...
zelTracerRTASBuilderBuildExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnBuildExtCb);
...
zelTracerRTASBuilderCommandListAppendCopyExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASBuilderCommandListAppendCopyExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnCommandListAppendCopyExtCb);
...
zelTracerRTASBuilderDestroyExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASBuilderDestroyExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnDestroyExtCb);
...
zelTracerRTASParallelOperationCreateExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASParallelOperationCreateExtRegisterCallback") );
...
zelTracerRTASParallelOperationGetPropertiesExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASParallelOperationGetPropertiesExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetPropertiesExtCb);
...
zelTracerRTASParallelOperationJoinExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnJoinExtCb);
...
zelTracerRTASParallelOperationDestroyExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerRTASParallelOperationDestroyExtRegisterCallback") );
...
zelTracerDeviceGetVectorWidthPropertiesExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceGetVectorWidthPropertiesExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetVectorWidthPropertiesExtCb);
...
zelTracerKernelGetAllocationPropertiesExpRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerKernelGetAllocationPropertiesExpRegisterCallback") );
...
zelTracerCommandListBeginGraphCaptureExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnBeginGraphCaptureExtCb);
...
zelTracerCommandListBeginCaptureIntoGraphExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnBeginCaptureIntoGraphExtCb);
...
zelTracerCommandListIsGraphCaptureEnabledExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnIsGraphCaptureEnabledExtCb);
...
zelTracerCommandListEndGraphCaptureExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListEndGraphCaptureExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnEndGraphCaptureExtCb);
...
zelTracerCommandListGetGraphExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnGetGraphExtCb);
...
zelTracerGraphGetPrimaryCommandListExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphGetPrimaryCommandListExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetPrimaryCommandListExtCb);
...
zelTracerGraphSetDestructionCallbackExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnSetDestructionCallbackExtCb);
...
zelTracerGraphInstantiateExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphInstantiateExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnInstantiateExtCb);
...
zelTracerCommandListAppendGraphExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendGraphExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendGraphExtCb);
...
zelTracerExecutableGraphGetSourceGraphExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerExecutableGraphGetSourceGraphExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetSourceGraphExtCb);
...
zelTracerGraphIsEmptyExtRegisterCallback(
    ...
    if(func)
        return func(hTracer, callback_type, pfnIsEmptyExtCb);
...
zelTracerGraphDumpContentsExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphDumpContentsExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnDumpContentsExtCb);
...
zelTracerGraphDestroyExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphDestroyExtRegisterCallback") );
...
zelTracerGraphPauseCaptureExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphPauseCaptureExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnPauseCaptureExtCb);
...
zelTracerGraphResumeCaptureExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphResumeCaptureExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnResumeCaptureExtCb);
...
zelTracerGraphGetIdExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerGraphGetIdExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetIdExtCb);
...
zelTracerCommandListAppendHostFunctionRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandListAppendHostFunctionRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnAppendHostFunctionCb);
...
zelTracerCommandQueueSetPriorityExtRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerCommandQueueSetPriorityExtRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnSetPriorityExtCb);
...
zelTracerDeviceGetCompilerInfoRegisterCallback(
    ...
    auto func = reinterpret_cast<ze_pfnSetCallback_t>(
        GET_FUNCTION_PTR(ze_lib::context->tracing_lib, "zelTracerDeviceGetCompilerInfoRegisterCallback") );

    if(func)
        return func(hTracer, callback_type, pfnGetCompilerInfoCb);
