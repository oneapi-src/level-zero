...
namespace validation_layer
{
    ...
    ze_result_t
    ZEParameterValidation::zeCommandListAppendSignalEventWithParametersPrologue(
        ze_command_list_handle_t hCommandList,          ///< [in] handle of the command list
    ...
    ze_result_t
    ZEParameterValidation::zeCommandListAppendWaitOnEventsWithParametersPrologue(
        ze_command_list_handle_t hCommandList,          ///< [in] handle of the command list
        const void * pNext,                             ///< [in][optional] additional parameters passed to the function
        uint32_t numEvents,                             ///< [in] number of events to wait on before continuing
        ze_event_handle_t* phEvents                     ///< [in][range(0, numEvents)] handles of the events to wait on before
    ...
    ze_result_t
    ZEParameterValidation::zeModuleGetDeviceHandlePrologue(
        ze_module_handle_t hModule,                     ///< [in] handle of the module
    ...
    ze_result_t
    ZEParameterValidation::zeKernelGetModuleHandlePrologue(
    ...
    ze_result_t
    ZEParameterValidation::zeGraphPauseCaptureExtPrologue(
    ...
    ze_result_t
    ZEParameterValidation::zeGraphResumeCaptureExtPrologue(
    ...
    ze_result_t
    ZEParameterValidation::zeGraphGetIdExtPrologue(
    ...
    ze_result_t
    ZEParameterValidation::zeCommandQueueSetPriorityExtPrologue(
        ze_command_queue_handle_t hCommandQueue,        ///< [in] handle of the command queue
        ...
        )
    {
        ...
        if( ZE_COMMAND_QUEUE_PRIORITY_PRIORITY_HIGH < priority )
            return ZE_RESULT_ERROR_INVALID_ENUMERATION;
    ...
    ze_result_t
    ZEParameterValidation::zeDeviceGetCompilerInfoPrologue(
        ze_device_handle_t hDevice,                     ///< [in] handle of the device
        ...
        )
    {
        ...
        if( ZE_DEVICE_COMPILER_INFO_DRIVER_OPTIONS < paramName )
            return ZE_RESULT_ERROR_INVALID_ENUMERATION;
