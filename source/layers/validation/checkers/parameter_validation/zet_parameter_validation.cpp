...
namespace validation_layer
{
    ...
    ze_result_t
    ZETParameterValidation::zetCommandListAppendMarkerExpPrologue(
    ...
    ze_result_t
    ZETParameterValidation::zetDeviceEnableMetricsExpPrologue(
    ...
    ze_result_t
    ZETParameterValidation::zetDeviceDisableMetricsExpPrologue(
