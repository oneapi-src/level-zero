...
{
    ze_result_t
    ZESHandleLifetimeValidation::zesDriverGetExtensionPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDriverGetExtensionFunctionAddressEpilogue(
        zes_driver_handle_t hDriver,                    ///< [in] handle of the driver instance
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceResetEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceResetExtEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle for the device
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceProcessesGetStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle for the device
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDevicePciGetPropertiesEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDevicePciGetStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDevicePciGetBarsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDevicePciGetStatsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceSetOverclockWaiverEpilogue(
        zes_device_handle_t hDevice                     ///< [in] Sysman handle of the device.
        )
    { 
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetOverclockDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetOverclockControlsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceResetOverclockSettingsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceReadOverclockStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumOverclockDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetDomainPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetDomainVFPropertiesEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetDomainControlPropertiesEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetControlCurrentValueEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetControlPendingValueEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
        zes_overclock_control_t DomainControl,          ///< [in] Overclock Control.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockSetControlUserValueEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetControlStateEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
        zes_overclock_control_t DomainControl,          ///< [in] Domain Control.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockGetVFPointValuesEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesOverclockSetVFPointValuesEpilogue(
        zes_overclock_handle_t hDomainHandle,           ///< [in] Handle for the component domain.
        zes_vf_type_t VFType,                           ///< [in] Voltage or Freqency point to read.
        uint32_t PointIndex,                            ///< [in] Point index - number between (0, max_num_points - 1).
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumDiagnosticTestSuitesEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDiagnosticsGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDiagnosticsGetTestsEpilogue(
        zes_diag_handle_t hDiagnostics,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDiagnosticsRunTestsEpilogue(
        zes_diag_handle_t hDiagnostics,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEccAvailableEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEccConfigurableEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetEccStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceSetEccStateEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumEngineGroupsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesEngineGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesEngineGetActivityEpilogue(
        zes_engine_handle_t hEngine,                    ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEventRegisterEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDriverEventListenEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDriverEventListenExEpilogue(
        ze_driver_handle_t hDriver,                     ///< [in] handle of the driver instance
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumFabricPortsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetLinkTypeEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetConfigEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortSetConfigEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetStateEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetThroughputEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetFabricErrorCountersEpilogue(
        zes_fabric_port_handle_t hPort,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFabricPortGetMultiPortThroughputEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumFansEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanGetConfigEpilogue(
        zes_fan_handle_t hFan,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanSetDefaultModeEpilogue(
        zes_fan_handle_t hFan                           ///< [in] Handle for the component.
        )
    { 
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanSetFixedSpeedModeEpilogue(
        zes_fan_handle_t hFan,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanSetSpeedTableModeEpilogue(
        zes_fan_handle_t hFan,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFanGetStateEpilogue(
        zes_fan_handle_t hFan,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumFirmwaresEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareFlashEpilogue(
        zes_firmware_handle_t hFirmware,                ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareGetFlashProgressEpilogue(
        zes_firmware_handle_t hFirmware,                ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareGetConsoleLogsEpilogue(
        zes_firmware_handle_t hFirmware,                ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumFrequencyDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyGetAvailableClocksEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyGetRangeEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencySetRangeEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyGetStateEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyGetThrottleTimeEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetCapabilitiesEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetFrequencyTargetEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcSetFrequencyTargetEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetVoltageTargetEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcSetVoltageTargetEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcSetModeEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetModeEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetIccMaxEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcSetIccMaxEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcGetTjMaxEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFrequencyOcSetTjMaxEpilogue(
        zes_freq_handle_t hFrequency,                   ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumLedsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesLedGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesLedGetStateEpilogue(
        zes_led_handle_t hLed,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesLedSetStateEpilogue(
        zes_led_handle_t hLed,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesLedSetColorEpilogue(
        zes_led_handle_t hLed,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumMemoryModulesEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesMemoryGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesMemoryGetStateEpilogue(
        zes_mem_handle_t hMemory,                       ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesMemoryGetBandwidthEpilogue(
        zes_mem_handle_t hMemory,                       ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumPerformanceFactorDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPerformanceFactorGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPerformanceFactorGetConfigEpilogue(
        zes_perf_handle_t hPerf,                        ///< [in] Handle for the Performance Factor domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPerformanceFactorSetConfigEpilogue(
        zes_perf_handle_t hPerf,                        ///< [in] Handle for the Performance Factor domain.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumPowerDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetCardPowerDomainEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerGetEnergyCounterEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerGetLimitsEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerSetLimitsEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerGetEnergyThresholdEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerSetEnergyThresholdEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumPsusEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPsuGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPsuGetStateEpilogue(
        zes_psu_handle_t hPsu,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumRasErrorSetsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasGetConfigEpilogue(
        zes_ras_handle_t hRas,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasSetConfigEpilogue(
        zes_ras_handle_t hRas,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasGetStateEpilogue(
        zes_ras_handle_t hRas,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumSchedulersEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerGetCurrentModeEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerGetTimeoutModePropertiesEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerGetTimesliceModePropertiesEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
        ze_bool_t getDefaults,                          ///< [in] If TRUE, the driver will return the system default properties for
                                                        ///< this mode, otherwise it will return the current properties.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerSetTimeoutModeEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerSetTimesliceModeEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerSetExclusiveModeEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
        ze_bool_t* pNeedReload                          ///< [in,out] Will be set to TRUE if a device driver reload is needed to
                                                        ///< apply the new scheduler mode.
        )
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesSchedulerSetComputeUnitDebugModeEpilogue(
        zes_sched_handle_t hScheduler,                  ///< [in] Sysman handle for the component.
        ze_bool_t* pNeedReload                          ///< [in,out] Will be set to TRUE if a device driver reload is needed to
                                                        ///< apply the new scheduler mode.
        )
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumStandbyDomainsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesStandbyGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesStandbyGetModeEpilogue(
        zes_standby_handle_t hStandby,                  ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesStandbySetModeEpilogue(
        zes_standby_handle_t hStandby,                  ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumTemperatureSensorsEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesTemperatureGetPropertiesEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesTemperatureGetConfigEpilogue(
        zes_temp_handle_t hTemperature,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesTemperatureSetConfigEpilogue(
        zes_temp_handle_t hTemperature,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesTemperatureGetStateEpilogue(
        zes_temp_handle_t hTemperature,                 ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerGetLimitsExtEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesPowerSetLimitsExtEpilogue(
        zes_pwr_handle_t hPower,                        ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesEngineGetActivityExtEpilogue(
        zes_engine_handle_t hEngine,                    ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasGetStateExpEpilogue(
        zes_ras_handle_t hRas,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesRasClearStateExpEpilogue(
        zes_ras_handle_t hRas,                          ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareGetSecurityVersionExpEpilogue(
        zes_firmware_handle_t hFirmware,                ///< [in] Handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesFirmwareSetSecurityVersionExpEpilogue(
        zes_firmware_handle_t hFirmware                 ///< [in] Handle for the component.
        )
    { 
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceGetSubDevicePropertiesExpEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDriverGetDeviceByUuidExpEpilogue(
        zes_driver_handle_t hDriver,                    ///< [in] handle of the sysman driver instance
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesDeviceEnumActiveVFExpEpilogue(
        zes_device_handle_t hDevice,                    ///< [in] Sysman handle of the device.
        uint32_t* pCount,                               ///< [in,out] pointer to the number of components of this type.
                                                        ///< if count is zero, then the driver shall update the value with the
                                                        ///< total number of components of this type that are available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesVFManagementGetVFPropertiesExpEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesVFManagementGetVFMemoryUtilizationExpEpilogue(
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesVFManagementGetVFEngineUtilizationExpEpilogue(
        zes_vf_handle_t hVFhandle,                      ///< [in] Sysman handle for the component.
        uint32_t* pCount,                               ///< [in,out] Pointer to the number of VF engine stats descriptors.
                                                        ///<  - if count is zero, the driver shall update the value with the total
                                                        ///< number of engine stats available.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesVFManagementSetVFTelemetryModeExpEpilogue(
        zes_vf_handle_t hVFhandle,                      ///< [in] Sysman handle for the component.
    ...
    ze_result_t
    ZESHandleLifetimeValidation::zesVFManagementSetVFTelemetrySamplingIntervalExpEpilogue(
        zes_vf_handle_t hVFhandle,                      ///< [in] Sysman handle for the component.
