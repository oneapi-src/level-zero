...
namespace tracing_layer
{
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Device.pfnGetCounterBasedEventMaxValue, hDevice, maxValue);

        // capture parameters
        ze_device_get_counter_based_event_max_value_params_t tracerParams = {
            &hDevice,
            &maxValue
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnDeviceGetCounterBasedEventMaxValueCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnDeviceGetCounterBasedEventMaxValueCb_t, Device, pfnGetCounterBasedEventMaxValueCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Device.pfnGetCounterBasedEventMaxValue,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phDevice,
                                                  *tracerParams.pmaxValue);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Device.pfnGetRuntimeRequirements, hDevice, pObjDesc, pSize, pRequirements);

        // capture parameters
        ze_device_get_runtime_requirements_params_t tracerParams = {
            &hDevice,
            &pObjDesc,
            &pSize,
            &pRequirements
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnDeviceGetRuntimeRequirementsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnDeviceGetRuntimeRequirementsCb_t, Device, pfnGetRuntimeRequirementsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Device.pfnGetRuntimeRequirements,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phDevice,
                                                  *tracerParams.ppObjDesc,
                                                  *tracerParams.ppSize,
                                                  *tracerParams.ppRequirements);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Device.pfnGetRuntimeRequirementsKey, hDevice, pKey);

        // capture parameters
        ze_device_get_runtime_requirements_key_params_t tracerParams = {
            &hDevice,
            &pKey
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnDeviceGetRuntimeRequirementsKeyCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnDeviceGetRuntimeRequirementsKeyCb_t, Device, pfnGetRuntimeRequirementsKeyCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Device.pfnGetRuntimeRequirementsKey,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Device.pfnValidateRuntimeRequirements, hDevice, pRequirements, pOut);

        // capture parameters
        ze_device_validate_runtime_requirements_params_t tracerParams = {
            &hDevice,
            &pRequirements,
            &pOut
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnDeviceValidateRuntimeRequirementsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnDeviceValidateRuntimeRequirementsCb_t, Device, pfnValidateRuntimeRequirementsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Device.pfnValidateRuntimeRequirements,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnGetOrdinal, hCommandQueue, pOrdinal);

        // capture parameters
        ze_command_queue_get_ordinal_params_t tracerParams = {
            &hCommandQueue,
            &pOrdinal
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueGetOrdinalCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnGetIndex, hCommandQueue, pIndex);

        // capture parameters
        ze_command_queue_get_index_params_t tracerParams = {
            &hCommandQueue,
            &pIndex
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueGetIndexCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnGetFlags, hCmdQueue, pFlags);

        // capture parameters
        ze_command_queue_get_flags_params_t tracerParams = {
            &hCmdQueue,
            &pFlags
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueGetFlagsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandQueueGetFlagsCb_t, CommandQueue, pfnGetFlagsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandQueue.pfnGetFlags,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCmdQueue,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnGetMode, hCmdQueue, pMode);

        // capture parameters
        ze_command_queue_get_mode_params_t tracerParams = {
            &hCmdQueue,
            &pMode
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueGetModeCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandQueueGetModeCb_t, CommandQueue, pfnGetModeCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandQueue.pfnGetMode,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnGetPriority, hCmdQueue, pPriority);

        // capture parameters
        ze_command_queue_get_priority_params_t tracerParams = {
            &hCmdQueue,
            &pPriority
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueGetPriorityCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandQueueGetPriorityCb_t, CommandQueue, pfnGetPriorityCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandQueue.pfnGetPriority,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCmdQueue,
                                                  *tracerParams.ppPriority);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnGetDeviceHandle, hCommandList, phDevice);

        // capture parameters
        ze_command_list_get_device_handle_params_t tracerParams = {
            &hCommandList,
            &phDevice
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetDeviceHandleCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnGetContextHandle, hCommandList, phContext);

        // capture parameters
        ze_command_list_get_context_handle_params_t tracerParams = {
            &hCommandList,
            &phContext
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetContextHandleCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnGetOrdinal, hCommandList, pOrdinal);

        // capture parameters
        ze_command_list_get_ordinal_params_t tracerParams = {
            &hCommandList,
            &pOrdinal
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetOrdinalCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnImmediateGetIndex, hCommandListImmediate, pIndex);

        // capture parameters
        ze_command_list_immediate_get_index_params_t tracerParams = {
            &hCommandListImmediate,
            &pIndex
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateGetIndexCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnGetFlags, hCommandList, pFlags);

        // capture parameters
        ze_command_list_get_flags_params_t tracerParams = {
            &hCommandList,
            &pFlags
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetFlagsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListGetFlagsCb_t, CommandList, pfnGetFlagsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnGetFlags,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnImmediateGetFlags, hCommandList, pFlags);

        // capture parameters
        ze_command_list_immediate_get_flags_params_t tracerParams = {
            &hCommandList,
            &pFlags
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateGetFlagsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListImmediateGetFlagsCb_t, CommandList, pfnImmediateGetFlagsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnImmediateGetFlags,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnImmediateGetMode, hCommandList, pMode);

        // capture parameters
        ze_command_list_immediate_get_mode_params_t tracerParams = {
            &hCommandList,
            &pMode
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateGetModeCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListImmediateGetModeCb_t, CommandList, pfnImmediateGetModeCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnImmediateGetMode,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnImmediateGetPriority, hCommandList, pPriority);

        // capture parameters
        ze_command_list_immediate_get_priority_params_t tracerParams = {
            &hCommandList,
            &pPriority
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateGetPriorityCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListImmediateGetPriorityCb_t, CommandList, pfnImmediateGetPriorityCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnImmediateGetPriority,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendMemoryCopyWithParameters, hCommandList, dstptr, srcptr, size, pNext, hSignalEvent, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_append_memory_copy_with_parameters_params_t tracerParams = {
            &hCommandList,
            &dstptr,
            &srcptr,
            &size,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendMemoryCopyWithParametersCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendMemoryCopyWithParametersCb_t, CommandList, pfnAppendMemoryCopyWithParametersCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendMemoryCopyWithParameters,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendMemoryFillWithParameters, hCommandList, ptr, pattern, pattern_size, size, pNext, hSignalEvent, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_append_memory_fill_with_parameters_params_t tracerParams = {
            &hCommandList,
            &ptr,
            &pattern,
            &pattern_size,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendMemoryFillWithParametersCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendMemoryFillWithParametersCb_t, CommandList, pfnAppendMemoryFillWithParametersCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendMemoryFillWithParameters,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnAppendSignalEventWithParameters = context.zeDdiTable.CommandList.pfnAppendSignalEventWithParameters;

        if( nullptr == pfnAppendSignalEventWithParameters)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendSignalEventWithParameters, hCommandList, pNext, hEvent);

        // capture parameters
        ze_command_list_append_signal_event_with_parameters_params_t tracerParams = {
            &hCommandList,
            &pNext,
            &hEvent
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendSignalEventWithParametersCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendSignalEventWithParametersCb_t, CommandList, pfnAppendSignalEventWithParametersCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendSignalEventWithParameters,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnAppendWaitOnEventsWithParameters = context.zeDdiTable.CommandList.pfnAppendWaitOnEventsWithParameters;

        if( nullptr == pfnAppendWaitOnEventsWithParameters)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendWaitOnEventsWithParameters, hCommandList, pNext, numEvents, phEvents);

        // capture parameters
        ze_command_list_append_wait_on_events_with_parameters_params_t tracerParams = {
            &hCommandList,
            &pNext,
            &numEvents,
            &phEvents
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendWaitOnEventsWithParametersCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendWaitOnEventsWithParametersCb_t, CommandList, pfnAppendWaitOnEventsWithParametersCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendWaitOnEventsWithParameters,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Event.pfnGetEventPool, hEvent, phEventPool);
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnEventGetEventPoolCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Event.pfnGetSignalScope, hEvent, pSignalScope);

        // capture parameters
        ze_event_get_signal_scope_params_t tracerParams = {
            &hEvent,
            &pSignalScope
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnEventGetSignalScopeCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Event.pfnGetWaitScope, hEvent, pWaitScope);

        // capture parameters
        ze_event_get_wait_scope_params_t tracerParams = {
            &hEvent,
            &pWaitScope
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnEventGetWaitScopeCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.EventPool.pfnGetContextHandle, hEventPool, phContext);

        // capture parameters
        ze_event_pool_get_context_handle_params_t tracerParams = {
            &hEventPool,
            &phContext
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnEventPoolGetContextHandleCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.EventPool.pfnGetFlags, hEventPool, pFlags);

        // capture parameters
        ze_event_pool_get_flags_params_t tracerParams = {
            &hEventPool,
            &pFlags
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnEventPoolGetFlagsCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Event.pfnGetCounterBasedFlags, hEvent, pFlags);

        // capture parameters
        ze_event_get_counter_based_flags_params_t tracerParams = {
            &hEvent,
            &pFlags
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnEventGetCounterBasedFlagsCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnEventGetCounterBasedFlagsCb_t, Event, pfnGetCounterBasedFlagsCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Event.pfnGetCounterBasedFlags,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnGetDeviceHandle = context.zeDdiTable.Module.pfnGetDeviceHandle;

        if( nullptr == pfnGetDeviceHandle)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Module.pfnGetDeviceHandle, hModule, phDevice);

        // capture parameters
        ze_module_get_device_handle_params_t tracerParams = {
            &hModule,
            &phDevice
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnModuleGetDeviceHandleCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnModuleGetDeviceHandleCb_t, Module, pfnGetDeviceHandleCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Module.pfnGetDeviceHandle,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnGetModuleHandle = context.zeDdiTable.Kernel.pfnGetModuleHandle;

        if( nullptr == pfnGetModuleHandle)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Kernel.pfnGetModuleHandle, hKernel, phModule);

        // capture parameters
        ze_kernel_get_module_handle_params_t tracerParams = {
            &hKernel,
            &phModule
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnKernelGetModuleHandleCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnKernelGetModuleHandleCb_t, Kernel, pfnGetModuleHandleCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Kernel.pfnGetModuleHandle,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.ImageExp.pfnGetDeviceOffsetExp, hImage, pDeviceOffset);

        // capture parameters
        ze_image_get_device_offset_exp_params_t tracerParams = {
            &hImage,
            &pDeviceOffset
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnImageGetDeviceOffsetExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnCreateCloneExp, hCommandList, phClonedCommandList);

        // capture parameters
        ze_command_list_create_clone_exp_params_t tracerParams = {
            &hCommandList,
            &phClonedCommandList
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListCreateCloneExpCb_t> apiCallbackData;
        ...
        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandListExp.pfnCreateCloneExp,
                                                  ...
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCommandList,
                                                  *tracerParams.pphClonedCommandList);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnImmediateAppendCommandListsExp, hCommandListImmediate, numCommandLists, phCommandLists, hSignalEvent, numWaitEvents, phWaitEvents);
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateAppendCommandListsExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnImmediateAppendCommandListsWithParameters, hCommandListImmediate, numCommandLists, phCommandLists, pNext, hSignalEvent, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_immediate_append_command_lists_with_parameters_params_t tracerParams = {
            &hCommandListImmediate,
            &numCommandLists,
            &phCommandLists,
            &pNext,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListImmediateAppendCommandListsWithParametersCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListImmediateAppendCommandListsWithParametersCb_t, CommandList, pfnImmediateAppendCommandListsWithParametersCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnImmediateAppendCommandListsWithParameters,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnGetNextCommandIdExp, hCommandList, desc, pCommandId);

        // capture parameters
        ze_command_list_get_next_command_id_exp_params_t tracerParams = {
            &hCommandList,
            &desc,
            &pCommandId
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetNextCommandIdExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnUpdateMutableCommandsExp, hCommandList, desc);

        // capture parameters
        ze_command_list_update_mutable_commands_exp_params_t tracerParams = {
            &hCommandList,
            &desc
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListUpdateMutableCommandsExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnIsMutableExp, hCommandList, pIsMutable);

        // capture parameters
        ze_command_list_is_mutable_exp_params_t tracerParams = {
            &hCommandList,
            &pIsMutable
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListIsMutableExpCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListIsMutableExpCb_t, CommandList, pfnIsMutableExpCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandListExp.pfnIsMutableExp,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCommandList,
                                                  *tracerParams.ppIsMutable);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnUpdateMutableCommandSignalEventExp, hCommandList, commandId, hSignalEvent);

        // capture parameters
        ze_command_list_update_mutable_command_signal_event_exp_params_t tracerParams = {
            &hCommandList,
            &commandId,
            &hSignalEvent
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListUpdateMutableCommandSignalEventExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandListExp.pfnUpdateMutableCommandWaitEventsExp, hCommandList, commandId, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_update_mutable_command_wait_events_exp_params_t tracerParams = {
            &hCommandList,
            &commandId,
            &numWaitEvents,
            &phWaitEvents
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListUpdateMutableCommandWaitEventsExpCb_t> apiCallbackData;
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnCreateExt, hContext, pNext, phGraph);
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphCreateExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphCreateExtCb_t, Graph, pfnCreateExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnCreateExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnBeginGraphCaptureExt, hCommandList, pNext);

        // capture parameters
        ze_command_list_begin_graph_capture_ext_params_t tracerParams = {
            &hCommandList,
            &pNext
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListBeginGraphCaptureExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListBeginGraphCaptureExtCb_t, CommandList, pfnBeginGraphCaptureExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnBeginGraphCaptureExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnBeginCaptureIntoGraphExt, hCommandList, hGraph, pNext);

        // capture parameters
        ze_command_list_begin_capture_into_graph_ext_params_t tracerParams = {
            &hCommandList,
            &hGraph,
            &pNext
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListBeginCaptureIntoGraphExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListBeginCaptureIntoGraphExtCb_t, CommandList, pfnBeginCaptureIntoGraphExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnBeginCaptureIntoGraphExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCommandList,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.ppNext);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnIsGraphCaptureEnabledExt, hCommandList);
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListIsGraphCaptureEnabledExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListIsGraphCaptureEnabledExtCb_t, CommandList, pfnIsGraphCaptureEnabledExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnIsGraphCaptureEnabledExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnEndGraphCaptureExt, hCommandList, pNext, phGraph);

        // capture parameters
        ze_command_list_end_graph_capture_ext_params_t tracerParams = {
            &hCommandList,
            &pNext,
            &phGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListEndGraphCaptureExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListEndGraphCaptureExtCb_t, CommandList, pfnEndGraphCaptureExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnEndGraphCaptureExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnGetGraphExt, hCommandList, phGraph);

        // capture parameters
        ze_command_list_get_graph_ext_params_t tracerParams = {
            &hCommandList,
            &phGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListGetGraphExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListGetGraphExtCb_t, CommandList, pfnGetGraphExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnGetGraphExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnGetPrimaryCommandListExt, hGraph, phCommandList);

        // capture parameters
        ze_graph_get_primary_command_list_ext_params_t tracerParams = {
            &hGraph,
            &phCommandList
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphGetPrimaryCommandListExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphGetPrimaryCommandListExtCb_t, Graph, pfnGetPrimaryCommandListExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnGetPrimaryCommandListExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnSetDestructionCallbackExt, hGraph, pfnCallback, pUserData, pNext);

        // capture parameters
        ze_graph_set_destruction_callback_ext_params_t tracerParams = {
            &hGraph,
            &pfnCallback,
            &pUserData,
            &pNext
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphSetDestructionCallbackExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphSetDestructionCallbackExtCb_t, Graph, pfnSetDestructionCallbackExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnSetDestructionCallbackExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.ppfnCallback,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnInstantiateExt, hGraph, pNext, phExecutableGraph);
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphInstantiateExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphInstantiateExtCb_t, Graph, pfnInstantiateExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnInstantiateExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.ppNext,
                                                  *tracerParams.pphExecutableGraph);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendGraphExt, hCommandList, hGraph, pNext, hSignalEvent, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_append_graph_ext_params_t tracerParams = {
            &hCommandList,
            &hGraph,
            &pNext,
            &hSignalEvent,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendGraphExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendGraphExtCb_t, CommandList, pfnAppendGraphExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendGraphExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.ExecutableGraph.pfnGetSourceGraphExt, hGraph, phSourceGraph);

        // capture parameters
        ze_executable_graph_get_source_graph_ext_params_t tracerParams = {
            &hGraph,
            &phSourceGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnExecutableGraphGetSourceGraphExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnExecutableGraphGetSourceGraphExtCb_t, ExecutableGraph, pfnGetSourceGraphExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.ExecutableGraph.pfnGetSourceGraphExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.pphSourceGraph);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnIsEmptyExt, hGraph);

        // capture parameters
        ze_graph_is_empty_ext_params_t tracerParams = {
            &hGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphIsEmptyExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphIsEmptyExtCb_t, Graph, pfnIsEmptyExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnIsEmptyExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnDumpContentsExt, hGraph, filePath, pNext);

        // capture parameters
        ze_graph_dump_contents_ext_params_t tracerParams = {
            &hGraph,
            &filePath,
            &pNext
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphDumpContentsExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphDumpContentsExtCb_t, Graph, pfnDumpContentsExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnDumpContentsExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.pfilePath,
                                                  *tracerParams.ppNext);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.ExecutableGraph.pfnDestroyExt, hGraph);

        // capture parameters
        ze_executable_graph_destroy_ext_params_t tracerParams = {
            &hGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnExecutableGraphDestroyExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnExecutableGraphDestroyExtCb_t, ExecutableGraph, pfnDestroyExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.ExecutableGraph.pfnDestroyExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnDestroyExt, hGraph);

        // capture parameters
        ze_graph_destroy_ext_params_t tracerParams = {
            &hGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphDestroyExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphDestroyExtCb_t, Graph, pfnDestroyExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnDestroyExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnPauseCaptureExt = context.zeDdiTable.Graph.pfnPauseCaptureExt;

        if( nullptr == pfnPauseCaptureExt)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnPauseCaptureExt, hGraph);

        // capture parameters
        ze_graph_pause_capture_ext_params_t tracerParams = {
            &hGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphPauseCaptureExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphPauseCaptureExtCb_t, Graph, pfnPauseCaptureExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnPauseCaptureExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnResumeCaptureExt = context.zeDdiTable.Graph.pfnResumeCaptureExt;

        if( nullptr == pfnResumeCaptureExt)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnResumeCaptureExt, hGraph);

        // capture parameters
        ze_graph_resume_capture_ext_params_t tracerParams = {
            &hGraph
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphResumeCaptureExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphResumeCaptureExtCb_t, Graph, pfnResumeCaptureExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnResumeCaptureExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
    ...
    {
        auto pfnGetIdExt = context.zeDdiTable.Graph.pfnGetIdExt;

        if( nullptr == pfnGetIdExt)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Graph.pfnGetIdExt, hGraph, pGraphId);

        // capture parameters
        ze_graph_get_id_ext_params_t tracerParams = {
            &hGraph,
            &pGraphId
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnGraphGetIdExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnGraphGetIdExtCb_t, Graph, pfnGetIdExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Graph.pfnGetIdExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phGraph,
                                                  *tracerParams.ppGraphId);
    }
        ...
        )
    {
        ...
        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandList.pfnAppendHostFunction, hCommandList, pfnHostFunction, pUserData, pNext, hSignalEvent, numWaitEvents, phWaitEvents);

        // capture parameters
        ze_command_list_append_host_function_params_t tracerParams = {
            &hCommandList,
            &pfnHostFunction,
            &pUserData,
            &pNext,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandListAppendHostFunctionCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandListAppendHostFunctionCb_t, CommandList, pfnAppendHostFunctionCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandList.pfnAppendHostFunction,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCommandList,
                                                  *tracerParams.ppfnHostFunction,
                                                  *tracerParams.ppUserData,
                                                  *tracerParams.ppNext,
                                                  *tracerParams.phSignalEvent,
                                                  *tracerParams.pnumWaitEvents,
    ...
    {
        auto pfnSetPriorityExt = context.zeDdiTable.CommandQueue.pfnSetPriorityExt;

        if( nullptr == pfnSetPriorityExt)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.CommandQueue.pfnSetPriorityExt, hCommandQueue, priority);

        // capture parameters
        ze_command_queue_set_priority_ext_params_t tracerParams = {
            &hCommandQueue,
            &priority
        };

        tracing_layer::APITracerCallbackDataImp<ze_pfnCommandQueueSetPriorityExtCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnCommandQueueSetPriorityExtCb_t, CommandQueue, pfnSetPriorityExtCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.CommandQueue.pfnSetPriorityExt,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phCommandQueue,
                                                  *tracerParams.ppriority);
    }
    ...
    {
        auto pfnGetCompilerInfo = context.zeDdiTable.Device.pfnGetCompilerInfo;

        if( nullptr == pfnGetCompilerInfo)
            return ZE_RESULT_ERROR_UNSUPPORTED_FEATURE;

        ZE_HANDLE_TRACER_RECURSION(context.zeDdiTable.Device.pfnGetCompilerInfo, hDevice, paramName, pNext, pSize, pData);

        // capture parameters
        ze_device_get_compiler_info_params_t tracerParams = {
            &hDevice,
            &paramName,
            &pNext,
            &pSize,
        ...
        tracing_layer::APITracerCallbackDataImp<ze_pfnDeviceGetCompilerInfoCb_t> apiCallbackData;

        ZE_GEN_PER_API_CALLBACK_STATE(apiCallbackData, ze_pfnDeviceGetCompilerInfoCb_t, Device, pfnGetCompilerInfoCb);


        return tracing_layer::APITracerWrapperImp<ze_result_t>(context.zeDdiTable.Device.pfnGetCompilerInfo,
                                                  &tracerParams,
                                                  apiCallbackData.apiOrdinal,
                                                  apiCallbackData.prologCallbacks,
                                                  apiCallbackData.epilogCallbacks,
                                                  *tracerParams.phDevice,
                                                  *tracerParams.pparamName,
                                                  *tracerParams.ppNext,
                                                  *tracerParams.ppSize,
                                                  *tracerParams.ppData);
    }
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_16) {
        ...
        pDdiTable->pfnGetRuntimeRequirements                 = tracing_layer::zeDeviceGetRuntimeRequirements;
    }
    if (version >= ZE_API_VERSION_1_16) {
        dditable.pfnGetRuntimeRequirementsKey                = pDdiTable->pfnGetRuntimeRequirementsKey;
        pDdiTable->pfnGetRuntimeRequirementsKey              = tracing_layer::zeDeviceGetRuntimeRequirementsKey;
    }
    if (version >= ZE_API_VERSION_1_16) {
        dditable.pfnValidateRuntimeRequirements              = pDdiTable->pfnValidateRuntimeRequirements;
        pDdiTable->pfnValidateRuntimeRequirements            = tracing_layer::zeDeviceValidateRuntimeRequirements;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetCounterBasedEventMaxValue             = pDdiTable->pfnGetCounterBasedEventMaxValue;
        pDdiTable->pfnGetCounterBasedEventMaxValue           = tracing_layer::zeDeviceGetCounterBasedEventMaxValue;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnGetCompilerInfo                          = pDdiTable->pfnGetCompilerInfo;
        pDdiTable->pfnGetCompilerInfo                        = tracing_layer::zeDeviceGetCompilerInfo;
    }
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_17) {
        ...
        pDdiTable->pfnGetFlags                               = tracing_layer::zeCommandQueueGetFlags;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetMode                                  = pDdiTable->pfnGetMode;
        pDdiTable->pfnGetMode                                = tracing_layer::zeCommandQueueGetMode;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetPriority                              = pDdiTable->pfnGetPriority;
        pDdiTable->pfnGetPriority                            = tracing_layer::zeCommandQueueGetPriority;
    }
    if (version >= ZE_API_VERSION_1_18) {
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_16) {
        ...
        pDdiTable->pfnAppendMemoryCopyWithParameters         = tracing_layer::zeCommandListAppendMemoryCopyWithParameters;
    }
    if (version >= ZE_API_VERSION_1_16) {
        dditable.pfnAppendMemoryFillWithParameters           = pDdiTable->pfnAppendMemoryFillWithParameters;
        pDdiTable->pfnAppendMemoryFillWithParameters         = tracing_layer::zeCommandListAppendMemoryFillWithParameters;
    }
    if (version >= ZE_API_VERSION_1_16) {
        dditable.pfnImmediateAppendCommandListsWithParameters    = pDdiTable->pfnImmediateAppendCommandListsWithParameters;
        pDdiTable->pfnImmediateAppendCommandListsWithParameters  = tracing_layer::zeCommandListImmediateAppendCommandListsWithParameters;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetFlags                                 = pDdiTable->pfnGetFlags;
        pDdiTable->pfnGetFlags                               = tracing_layer::zeCommandListGetFlags;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnImmediateGetFlags                        = pDdiTable->pfnImmediateGetFlags;
        pDdiTable->pfnImmediateGetFlags                      = tracing_layer::zeCommandListImmediateGetFlags;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnImmediateGetMode                         = pDdiTable->pfnImmediateGetMode;
        pDdiTable->pfnImmediateGetMode                       = tracing_layer::zeCommandListImmediateGetMode;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnImmediateGetPriority                     = pDdiTable->pfnImmediateGetPriority;
        pDdiTable->pfnImmediateGetPriority                   = tracing_layer::zeCommandListImmediateGetPriority;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnBeginGraphCaptureExt                     = pDdiTable->pfnBeginGraphCaptureExt;
        pDdiTable->pfnBeginGraphCaptureExt                   = tracing_layer::zeCommandListBeginGraphCaptureExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnBeginCaptureIntoGraphExt                 = pDdiTable->pfnBeginCaptureIntoGraphExt;
        pDdiTable->pfnBeginCaptureIntoGraphExt               = tracing_layer::zeCommandListBeginCaptureIntoGraphExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnIsGraphCaptureEnabledExt                 = pDdiTable->pfnIsGraphCaptureEnabledExt;
        pDdiTable->pfnIsGraphCaptureEnabledExt               = tracing_layer::zeCommandListIsGraphCaptureEnabledExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnEndGraphCaptureExt                       = pDdiTable->pfnEndGraphCaptureExt;
        pDdiTable->pfnEndGraphCaptureExt                     = tracing_layer::zeCommandListEndGraphCaptureExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetGraphExt                              = pDdiTable->pfnGetGraphExt;
        pDdiTable->pfnGetGraphExt                            = tracing_layer::zeCommandListGetGraphExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnAppendGraphExt                           = pDdiTable->pfnAppendGraphExt;
        pDdiTable->pfnAppendGraphExt                         = tracing_layer::zeCommandListAppendGraphExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnAppendHostFunction                       = pDdiTable->pfnAppendHostFunction;
        pDdiTable->pfnAppendHostFunction                     = tracing_layer::zeCommandListAppendHostFunction;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnAppendSignalEventWithParameters          = pDdiTable->pfnAppendSignalEventWithParameters;
        pDdiTable->pfnAppendSignalEventWithParameters        = tracing_layer::zeCommandListAppendSignalEventWithParameters;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnAppendWaitOnEventsWithParameters         = pDdiTable->pfnAppendWaitOnEventsWithParameters;
        pDdiTable->pfnAppendWaitOnEventsWithParameters       = tracing_layer::zeCommandListAppendWaitOnEventsWithParameters;
    }
    if (version >= ZE_API_VERSION_1_3) {
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnIsMutableExp                             = pDdiTable->pfnIsMutableExp;
        pDdiTable->pfnIsMutableExp                           = tracing_layer::zeCommandListIsMutableExp;
    }
    if (version >= ZE_API_VERSION_1_9) {
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetCounterBasedFlags                     = pDdiTable->pfnGetCounterBasedFlags;
        pDdiTable->pfnGetCounterBasedFlags                   = tracing_layer::zeEventGetCounterBasedFlags;
    }
    if (version >= ZE_API_VERSION_1_6) {
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnGetModuleHandle                          = pDdiTable->pfnGetModuleHandle;
        pDdiTable->pfnGetModuleHandle                        = tracing_layer::zeKernelGetModuleHandle;
    }
    return result;
}
    ...
    )
{
    ...
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnGetDeviceHandle                          = pDdiTable->pfnGetDeviceHandle;
        pDdiTable->pfnGetDeviceHandle                        = tracing_layer::zeModuleGetDeviceHandle;
    }
    if (version >= ZE_API_VERSION_1_3) {
...
{
    auto& dditable = tracing_layer::context.zeDdiTable.ExecutableGraph;
    ...
    if (version >= ZE_API_VERSION_1_17) {
        ...
        pDdiTable->pfnGetSourceGraphExt                      = tracing_layer::zeExecutableGraphGetSourceGraphExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnDestroyExt                               = pDdiTable->pfnDestroyExt;
        pDdiTable->pfnDestroyExt                             = tracing_layer::zeExecutableGraphDestroyExt;
    }
    return result;
}
...
{
    auto& dditable = tracing_layer::context.zeDdiTable.Graph;
    ...
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnCreateExt                                = pDdiTable->pfnCreateExt;
        pDdiTable->pfnCreateExt                              = tracing_layer::zeGraphCreateExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnGetPrimaryCommandListExt                 = pDdiTable->pfnGetPrimaryCommandListExt;
        pDdiTable->pfnGetPrimaryCommandListExt               = tracing_layer::zeGraphGetPrimaryCommandListExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnSetDestructionCallbackExt                = pDdiTable->pfnSetDestructionCallbackExt;
        pDdiTable->pfnSetDestructionCallbackExt              = tracing_layer::zeGraphSetDestructionCallbackExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnInstantiateExt                           = pDdiTable->pfnInstantiateExt;
        pDdiTable->pfnInstantiateExt                         = tracing_layer::zeGraphInstantiateExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnIsEmptyExt                               = pDdiTable->pfnIsEmptyExt;
        pDdiTable->pfnIsEmptyExt                             = tracing_layer::zeGraphIsEmptyExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnDumpContentsExt                          = pDdiTable->pfnDumpContentsExt;
        pDdiTable->pfnDumpContentsExt                        = tracing_layer::zeGraphDumpContentsExt;
    }
    if (version >= ZE_API_VERSION_1_17) {
        dditable.pfnDestroyExt                               = pDdiTable->pfnDestroyExt;
        pDdiTable->pfnDestroyExt                             = tracing_layer::zeGraphDestroyExt;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnPauseCaptureExt                          = pDdiTable->pfnPauseCaptureExt;
        pDdiTable->pfnPauseCaptureExt                        = tracing_layer::zeGraphPauseCaptureExt;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnResumeCaptureExt                         = pDdiTable->pfnResumeCaptureExt;
        pDdiTable->pfnResumeCaptureExt                       = tracing_layer::zeGraphResumeCaptureExt;
    }
    if (version >= ZE_API_VERSION_1_18) {
        dditable.pfnGetIdExt                                 = pDdiTable->pfnGetIdExt;
        pDdiTable->pfnGetIdExt                               = tracing_layer::zeGraphGetIdExt;
    }
    return result;
}
