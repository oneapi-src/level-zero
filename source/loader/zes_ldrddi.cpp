...
namespace loader
{
    ...
    zesloaderInitDriverDDITables(loader::driver_t *driver) {
        ...
        result = ZE_RESULT_SUCCESS;
        // Optional DDI Table, ignore failure if a driver implements the ddi table, but returns an error.
        zesGetInfoLogProcAddrTableFromDriver(driver);
        result = ZE_RESULT_SUCCESS;
        // Optional DDI Table, ignore failure if a driver implements the ddi table, but returns an error.
        zesGetInfoLogInstanceProcAddrTableFromDriver(driver);
        result = ZE_RESULT_SUCCESS;
        return result;
    }
    ///////////////////////////////////////////////////////////////////////////////
        ...
        )
    {
        ...
        auto pfnGetProperties = dditable->zes.Driver.pfnGetProperties;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_driver_object_t*>( hDriver )->dditable;
        auto pfnEventRegisterExt = dditable->zes.Driver.pfnEventRegisterExt;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_driver_object_t*>( hDriver )->dditable;
        auto pfnEventListenExt = dditable->zes.Driver.pfnEventListenExt;
        ...
        // forward to device-driver
        result = pfnEventListenExt( hDriver, timeout, count, phDevicesLocal, pNumDeviceEvents, pEvents, pDriverEvents );
        delete []phDevicesLocal;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_driver_object_t*>( hDriver )->dditable;
        auto pfnEnumInfoLogsExt = dditable->zes.Driver.pfnEnumInfoLogsExt;
        ...
        try
        {
            ...
            for( size_t i = 0; ( nullptr != phInfoLogs ) && ( i < *pCount ); ++i )
                phInfoLogs[ i ] = reinterpret_cast<zes_info_log_handle_t>(
                    context->zes_info_log_factory.getInstance( phInfoLogs[ i ], dditable ) );
        }
        catch( std::bad_alloc& )
        {
            result = ZE_RESULT_ERROR_OUT_OF_HOST_MEMORY;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_info_log_object_t*>( hInfoLog )->dditable;
        auto pfnGetPropertiesExt = dditable->zes.InfoLog.pfnGetPropertiesExt;
        if( nullptr == pfnGetPropertiesExt )
            return ZE_RESULT_ERROR_UNINITIALIZED;

        // convert loader handle to driver handle
        hInfoLog = reinterpret_cast<zes_info_log_object_t*>( hInfoLog )->handle;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_info_log_object_t*>( hInfoLog )->dditable;
        auto pfnCreateInstanceExt = dditable->zes.InfoLog.pfnCreateInstanceExt;
        ...
        {
            // convert driver handle to loader handle
            *phInfoLogInstance = reinterpret_cast<zes_info_log_instance_handle_t>(
                context->zes_info_log_instance_factory.getInstance( *phInfoLogInstance, dditable ) );
        }
        catch( std::bad_alloc& )
        {
            result = ZE_RESULT_ERROR_OUT_OF_HOST_MEMORY;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_info_log_instance_object_t*>( hInfoLogInstance )->dditable;
        auto pfnReadWithMetadataExt = dditable->zes.InfoLogInstance.pfnReadWithMetadataExt;
        if( nullptr == pfnReadWithMetadataExt )
            return ZE_RESULT_ERROR_UNINITIALIZED;

        // convert loader handle to driver handle
        hInfoLogInstance = reinterpret_cast<zes_info_log_instance_object_t*>( hInfoLogInstance )->handle;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_info_log_instance_object_t*>( hInfoLogInstance )->dditable;
        auto pfnPeekWithMetadataExt = dditable->zes.InfoLogInstance.pfnPeekWithMetadataExt;
        ...
        )
    {
        ...
        // extract driver's function pointer table
        auto dditable = reinterpret_cast<zes_info_log_instance_object_t*>( hInfoLogInstance )->dditable;
        auto pfnDeleteExt = dditable->zes.InfoLogInstance.pfnDeleteExt;
        ...
        context->zes_info_log_instance_factory.release( hInfoLogInstance );
...
zesGetDriverProcAddrTableLegacy()
{
    ...
    loader::loaderDispatch->pSysman->Driver->pfnGetProperties                            = loader::zesDriverGetProperties;
    loader::loaderDispatch->pSysman->Driver->pfnEventRegisterExt                         = loader::zesDriverEventRegisterExt;
    loader::loaderDispatch->pSysman->Driver->pfnEventListenExt                           = loader::zesDriverEventListenExt;
    loader::loaderDispatch->pSysman->Driver->pfnEnumInfoLogsExt                          = loader::zesDriverEnumInfoLogsExt;
...
///////////////////////////////////////////////////////////////////////////////
/// @brief function for filling the legacy api pointers for InfoLog table
__zedlllocal void ZE_APICALL
zesGetInfoLogProcAddrTableLegacy()
{
    // return pointers to the Loader's Functions.
    loader::loaderDispatch->pSysman->InfoLog->pfnGetPropertiesExt                         = loader::zesInfoLogGetPropertiesExt;
    loader::loaderDispatch->pSysman->InfoLog->pfnCreateInstanceExt                        = loader::zesInfoLogCreateInstanceExt;
}

///////////////////////////////////////////////////////////////////////////////
/// @brief function for filling the legacy api pointers for InfoLogInstance table
__zedlllocal void ZE_APICALL
zesGetInfoLogInstanceProcAddrTableLegacy()
{
    // return pointers to the Loader's Functions.
    loader::loaderDispatch->pSysman->InfoLogInstance->pfnReadWithMetadataExt                      = loader::zesInfoLogInstanceReadWithMetadataExt;
    loader::loaderDispatch->pSysman->InfoLogInstance->pfnPeekWithMetadataExt                      = loader::zesInfoLogInstancePeekWithMetadataExt;
    loader::loaderDispatch->pSysman->InfoLogInstance->pfnDeleteExt                                = loader::zesInfoLogInstanceDeleteExt;
}
...
///     - ::ZE_RESULT_ERROR_UNSUPPORTED_VERSION
__zedlllocal ze_result_t ZE_APICALL
zesGetInfoLogProcAddrTableFromDriver(loader::driver_t *driver)
{
    ze_result_t result = ZE_RESULT_SUCCESS;
    if(driver->initStatus != ZE_RESULT_SUCCESS)
        return driver->initStatus;
    auto getTable = reinterpret_cast<zes_pfnGetInfoLogProcAddrTable_t>(
        GET_FUNCTION_PTR( driver->handle, "zesGetInfoLogProcAddrTable") );
    if(!getTable) 
        return driver->initStatus;
    result = getTable( loader::context->ddi_init_version, &driver->dditable.zes.InfoLog);
    return result;
}
///////////////////////////////////////////////////////////////////////////////
...
///     - ::ZE_RESULT_ERROR_UNSUPPORTED_VERSION
__zedlllocal ze_result_t ZE_APICALL
zesGetInfoLogInstanceProcAddrTableFromDriver(loader::driver_t *driver)
{
    ze_result_t result = ZE_RESULT_SUCCESS;
    if(driver->initStatus != ZE_RESULT_SUCCESS)
        return driver->initStatus;
    auto getTable = reinterpret_cast<zes_pfnGetInfoLogInstanceProcAddrTable_t>(
        GET_FUNCTION_PTR( driver->handle, "zesGetInfoLogInstanceProcAddrTable") );
    if(!getTable) 
        return driver->initStatus;
    result = getTable( loader::context->ddi_init_version, &driver->dditable.zes.InfoLogInstance);
    return result;
}
///////////////////////////////////////////////////////////////////////////////
/// @brief Exported function for filling application's Global table
    ...
    )
{
    ...
    if( ZE_RESULT_SUCCESS == result )
    {
        if( ( loader::context->sysmanInstanceDrivers->size() > 1 ) || loader::context->forceIntercept )
        {
            ...
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnGetProperties                            = loader_driver_ddi::zesDriverGetProperties;
            } else {
                pDdiTable->pfnGetProperties                            = loader::zesDriverGetProperties;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnEventRegisterExt                         = loader_driver_ddi::zesDriverEventRegisterExt;
            } else {
                pDdiTable->pfnEventRegisterExt                         = loader::zesDriverEventRegisterExt;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnEventListenExt                           = loader_driver_ddi::zesDriverEventListenExt;
            } else {
                pDdiTable->pfnEventListenExt                           = loader::zesDriverEventListenExt;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnEnumInfoLogsExt                          = loader_driver_ddi::zesDriverEnumInfoLogsExt;
            } else {
                pDdiTable->pfnEnumInfoLogsExt                          = loader::zesDriverEnumInfoLogsExt;
            }
            }
            if (version >= ZE_API_VERSION_1_5) {
        ...
        else
        {
            ...
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnGetProperties                            = firstDriver->dditable.zes.Driver.pfnGetProperties;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnEventRegisterExt                         = firstDriver->dditable.zes.Driver.pfnEventRegisterExt;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnEventListenExt                           = firstDriver->dditable.zes.Driver.pfnEventListenExt;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnEnumInfoLogsExt                          = firstDriver->dditable.zes.Driver.pfnEnumInfoLogsExt;
            }
            if (version >= ZE_API_VERSION_1_5) {
    ...
    )
{
    ...
    auto firstDriver = &loader::context->sysmanInstanceDrivers->at(0);
    if (driverCount == 1 && firstDriver && !loader::context->forceIntercept) {
        result = zesGetInfoLogProcAddrTableFromDriver(firstDriver);
    }
    ...
    if( ZE_RESULT_SUCCESS == result )
    {
        ...
        {
            // return pointers to loader's DDIs
            loader::loaderDispatch->pSysman->InfoLog = new zes_info_log_dditable_t;
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnGetPropertiesExt                         = loader_driver_ddi::zesInfoLogGetPropertiesExt;
            } else {
                pDdiTable->pfnGetPropertiesExt                         = loader::zesInfoLogGetPropertiesExt;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnCreateInstanceExt                        = loader_driver_ddi::zesInfoLogCreateInstanceExt;
            } else {
                pDdiTable->pfnCreateInstanceExt                        = loader::zesInfoLogCreateInstanceExt;
            }
            }
            zesGetInfoLogProcAddrTableLegacy();
        }
        else
        {
            // return pointers directly to driver's DDIs
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnGetPropertiesExt                         = firstDriver->dditable.zes.InfoLog.pfnGetPropertiesExt;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnCreateInstanceExt                        = firstDriver->dditable.zes.InfoLog.pfnCreateInstanceExt;
            }
        }
    }
    ...
    {
        auto getTable = reinterpret_cast<zes_pfnGetInfoLogProcAddrTable_t>(
            GET_FUNCTION_PTR(loader::context->validationLayer, "zesGetInfoLogProcAddrTable") );
        if(!getTable)
            return ZE_RESULT_ERROR_UNINITIALIZED;
        result = getTable( version, pDdiTable );
    }
    ...
    )
{
    ...
    auto firstDriver = &loader::context->sysmanInstanceDrivers->at(0);
    if (driverCount == 1 && firstDriver && !loader::context->forceIntercept) {
        result = zesGetInfoLogInstanceProcAddrTableFromDriver(firstDriver);
    }
    ...
    if( ZE_RESULT_SUCCESS == result )
    {
        ...
        {
            // return pointers to loader's DDIs
            loader::loaderDispatch->pSysman->InfoLogInstance = new zes_info_log_instance_dditable_t;
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnReadWithMetadataExt                      = loader_driver_ddi::zesInfoLogInstanceReadWithMetadataExt;
            } else {
                pDdiTable->pfnReadWithMetadataExt                      = loader::zesInfoLogInstanceReadWithMetadataExt;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnPeekWithMetadataExt                      = loader_driver_ddi::zesInfoLogInstancePeekWithMetadataExt;
            } else {
                pDdiTable->pfnPeekWithMetadataExt                      = loader::zesInfoLogInstancePeekWithMetadataExt;
            }
            }
            if (version >= ZE_API_VERSION_1_19) {
            if (loader::context->driverDDIPathDefault) {
                pDdiTable->pfnDeleteExt                                = loader_driver_ddi::zesInfoLogInstanceDeleteExt;
            } else {
                pDdiTable->pfnDeleteExt                                = loader::zesInfoLogInstanceDeleteExt;
            }
            }
            zesGetInfoLogInstanceProcAddrTableLegacy();
        }
        else
        {
            // return pointers directly to driver's DDIs
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnReadWithMetadataExt                      = firstDriver->dditable.zes.InfoLogInstance.pfnReadWithMetadataExt;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnPeekWithMetadataExt                      = firstDriver->dditable.zes.InfoLogInstance.pfnPeekWithMetadataExt;
            }
            if (version >= ZE_API_VERSION_1_19) {
                pDdiTable->pfnDeleteExt                                = firstDriver->dditable.zes.InfoLogInstance.pfnDeleteExt;
            }
        }
    }
    ...
    {
        auto getTable = reinterpret_cast<zes_pfnGetInfoLogInstanceProcAddrTable_t>(
            GET_FUNCTION_PTR(loader::context->validationLayer, "zesGetInfoLogInstanceProcAddrTable") );
        if(!getTable)
            return ZE_RESULT_ERROR_UNINITIALIZED;
        result = getTable( version, pDdiTable );
    }
